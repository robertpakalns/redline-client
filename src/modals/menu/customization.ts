...
const createCustomizationSection = (cont: HTMLElement): void => {
    ...
    const fastCSSValue = cont.querySelector("#fastCSSValue") as HTMLTextAreaElement
    ...
    const enableFastCSS = cont.querySelector("#enableFastCSS") as HTMLInputElement
    ...
    const _enableKeybinding = cont.querySelector("#enableKeybinding") as HTMLInputElement
    const _keybindingTable = cont.querySelector("#keybindingTable") as HTMLElement
